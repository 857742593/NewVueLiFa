    ...
    methods: {
      ...
      */
      getAllList() {
        this.$axios({
          method: 'get',
          url: 'http://localhost:8080/LiFaManagement/vipList/getAllList',
        }).then(response => {
      ...
      */
      getVipById() {
        ...
        this.$axios({
          method: 'post',
          url: 'http://localhost:8080/LiFaManagement/vipList/getVipById',
          data: postData
        }).then(response => {
          this.tableData = response.data
          this.total = this.tableData.length
      ...
      updateVip() {
        ...
        this.$axios({
          method: 'post',
          url: 'http://localhost:8080/LiFaManagement/vipList/updateVip',
          data: postData
        }).then(response => {
      ...
      deleteVip(index, row) {
        this.$confirm('删除操作, 是否继续?', '提示', {
          ...
          this.$axios({
            method: 'post',
            url: 'http://localhost:8080/LiFaManagement/vipList/deleteVip',
            data: postData
          }).then(response => {
            this.$message({
              type: 'success',
